function  lrr_patch_textons_lrrFF_guiding( image_name , options)
...
% imshow(J , [])
if isfield(options , 'dow_sampling' );
    J=imresize(J, dow_sampling/size(J,2));
...
patch_id  = compute_uniformly_size_patch(J , patch_size , over_size) ; %bar 下采样160 子块16,8 start 下采样160块 子块12 6
...
patch_prior3 = patch_blemish_prior_textons_compare( J , 'rand' , patch_id) ;
